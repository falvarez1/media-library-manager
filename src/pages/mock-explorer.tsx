      ...
      <main className="max-w-7xl mx-auto px-4 py-6">
        <div className="bg-white rounded-lg shadow overflow-hidden">
          ...
          <div className="p-6">
            ...
            {activeTab === 'media' && <MediaSection mediaId={id as string | null} />}
            {activeTab === 'folders' && <FoldersSection folderId={id as string | null} />}
            {activeTab === 'collections' && <CollectionsSection collectionId={id as string | null} />}
            {activeTab === 'tags' && <TagsSection tagId={id as string | null} />}
            {activeTab === 'users' && <UsersSection userId={id as string | null} />}
...
const DataCard: React.FC<DataCardProps> = ({ title, count, description, link }) => {
  return (
              ...
              <div className="md:w-2/3">
                ...
                <div className="mb-4">
                  ...
                  <div className="flex flex-wrap gap-1">
                    {mediaItem.tags && mediaItem.tags.map((tag: string) => (
                ...
                {mediaItem.ai_tags && (
                  <div className="mb-4">
                    ...
                    <div className="flex flex-wrap gap-1">
                      {mediaItem.ai_tags.map((tag: string) => (
                ...
                {mediaItem.used && (
                  <div>
                    ...
                    <div className="flex flex-wrap gap-1">
                      {mediaItem.usedIn && mediaItem.usedIn.map((page: string) => (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <div className="space-y-1">
                    {user.recentFolders.map((folderId: string) => {
                      const folder = mockData.folders.find((f: any) => f.id === folderId);
                      return folder ? (
                        <Link 
                          key={folderId}
                ...
                <div>
                  ...
                  <div className="space-y-1">
                    {user.recentFiles.map((fileId: string) => {
                      const file = mockData.media.find((m: any) => m.id === fileId);
                      return file ? (
                        <Link 
                          key={fileId}
...
const ApiTestSection: React.FC = () => {
  ...
  const runTest = async (test: ApiTest): Promise<void> => {
